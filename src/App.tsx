      ...
      <div className="min-h-screen bg-[#020617] text-slate-200 font-inter selection:bg-indigo-500/30">
            ...
            >
              <div className="p-6 flex items-center justify-between border-b border-white/5">
                 <div className={`flex items-center gap-3 ${(isSidebarOpen || window.innerWidth < 1024) ? 'flex' : 'hidden'}`}>
                    ...
                    <div>
                      <h1 className="text-sm font-black tracking-widest text-white uppercase">Aetherium</h1>
                      <p className="text-[9px] text-indigo-400 font-bold uppercase tracking-widest">Neural Engine</p>
                    </div>
                 </div>
                 <button 
            ...
            {/* Main Content */}
            <main className={`transition-all duration-300 min-h-screen ${isSidebarOpen ? 'lg:pl-[280px]' : 'lg:pl-[80px]'} pl-0`}>
               {/* Top Header */}
                  ...
                  <div className="flex items-center gap-4">
                      ...
                      {company && (
                        <div className="hidden sm:flex items-center gap-2 px-4 py-1.5 bg-indigo-500/10 border border-indigo-500/20 rounded-full">
                           ...
                           <span className="text-[10px] font-black uppercase tracking-widest text-indigo-400 truncate max-w-[100px] md:max-w-none">{company.name}</span>
                        </div>
                      )}
                  </div>
